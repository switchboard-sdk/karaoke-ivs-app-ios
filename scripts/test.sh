...
SCHEME="KaraokeWithAmazonIVSApp"
# Standardized to iPhone 17 (the runtime available on the Xcode 26 node); the
# previous "iPhone 15, OS=17.2" pin is not installed there.
